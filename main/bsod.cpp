...
void bsodFatal(const char *component)
{
	...
	if (f)
	{
		...
		stringFromFile(f, "oe", "/proc/enigma/oe");
		stringFromFile(f, "python", "/proc/enigma/python");
		stringFromFile(f, "mediaservice", "/proc/enigma/mediaservice");
		stringFromFile(f, "architecture", "/proc/enigma/architecture");
		stringFromFile(f, "multilib", "/proc/enigma/multilib");
		stringFromFile(f, "imgversion", "/proc/enigma/imgversion");
		stringFromFile(f, "imgrevision", "/proc/enigma/imgrevision");
		...
		stringFromFile(f, "feedsurl", "/proc/enigma/feedsurl");
